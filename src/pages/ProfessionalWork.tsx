export const ProfessionalWork = () => {
  return (
    <div>
      ...
      <p>
        Project description: xarvio Field Manager is a digital farming platform designed to help farmers and agronomists
        optimize crop production from planting (seeding) through to harvest by providing field- and field-zone-specific
        data, insights, and recommendations. It uses satellite imagery, weather data, crop models, and historical field
        information to support precise decision-making and efficiency improvements in crop management.
      </p>
      <p>
